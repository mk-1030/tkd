            ...
            <div class="p-news-arichive">
                ...
                <div class="c-posts-tab p-news-arichive__inr">
                    ...
                    <nav class="c-posts-tab__nav p-news-arichive__cate-list">
                        <ul class="c-posts-tab__nav-list">
                            <li class="c-posts-tab__nav-item"><a href="/news/">すべて</a></li>
                            <?php
                ...
                <div class="c-pager">
                    <div class="c-pager__wrap">
                        <?php if($paged > 1): ?>
                        <a class="c-pager__link-most" href="/news/<?php echo $term_slug; ?>">＜最初</a>
                            <?php if($paged > 2): ?>
                                <a class="c-pager__link is-active" href="/news/<?php echo $term_slug; ?>/page/<?php echo $paged - 1; ?>">前の10件へ</a>
                            <?php else: ?>
                                <a class="c-pager__link is-active" href="/news/<?php echo $term_slug; ?>">前の10件へ</a>
                            <?php endif; ?>
                        <?php else: ?>
                    ...
                    <div class="c-pager__wrap">
                        ...
                        <?php else: ?>
                        <a class="c-pager__link is-active" href="/news/<?php echo $term_slug; ?>/page/<?php echo $paged + 1; ?>">次の10件へ</a>
                        <a class="c-pager__link-most" href="/news/<?php echo $term_slug; ?>/page/<?php echo $max_page; ?>">最後＞</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
