<?php /*Template Name: IR情報 - IRライブラリ - 有価証券報告書 */ ?>
            ...
            <div class="p-ir-library">
                <nav class="c-cate-nav">
                    <ul class="c-cate-nav__list">
                        ...
                        <li class="c-cate-nav__item is-current"><a href="/ir/library/securities-report"><span>有価証券報告書</span></a></li>
                ...
                <div class="c-headline01 p-ir-library-ttl">
                    <p class="c-headline01__big"><span>Securities Report</span></p>
                    <h1 class="c-headline01__small"><span>有価証券報告書</span></h1>
                </div>
...
scriptLoader.load(
function(){setParts('file_yuho_005');  }, showMaintenanceMessage);
</script>
<!-- /E-IR Parts -->
