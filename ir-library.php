<?php /*Template Name: IR情報 - IRライブラリ */ ?>
...
<main class="l-main">
    <div class="c-page-ttl">
        <div class="u-container u-container--wide">
            <div class="c-page-ttl__txt">
                ...
                <h1 class="c-page-ttl__small"><span>IRライブラリ</span></h1>
            </div>
        </div>
    </div>
    ...
    <div class="c-breadcrumbs u-container u-container--wide">
        <ul>
            ...
            <li class="separ">|</li>
            <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                <a itemprop="item" href="/ir/"><span itemprop="name">IR情報</span><meta itemprop="position" content="3"></a>
            </li>
            <li class="separ">|</li>
            <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
