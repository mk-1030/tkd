<?php /*Template Name: IR情報 - IRライブラリ - 決算短信 */ ?>
            ...
            <div class="p-ir-library">
                <nav class="c-cate-nav">
                    <ul class="c-cate-nav__list">
                        <li class="c-cate-nav__item is-current"><a class="is-current" href="/ir/library/finacial-restults"><span>決算短信</span></a></li>
                        <li class="c-cate-nav__item"><a href="/ir/library/securities-report"><span>有価証券報告書</span></a></li>
                        <li class="c-cate-nav__item"><a href="/ir/library/stockholders-metting"><span>株主総会</span></a></li>
                        <li class="c-cate-nav__item"><a href="/ir/library/annual-report"><span>株主通信</span></a></li>
                    </ul>
                </nav>

                <div class="c-headline01 p-ir-library-ttl">
                    <p class="c-headline01__big"><span>Finacial Restults</span></p>
                    <h1 class="c-headline01__small"><span>決算短信</span></h1>
                </div>

                <!-- E-IR Parts -->
<div class="eir" data-area-name="area_tanshin_003"></div>
...
scriptLoader.load(
function(){setParts('file_tanshin_004');  }, showMaintenanceMessage);
</script>
<!-- /E-IR Parts -->
