<?php /*Template Name: IR情報 - IRライブラリ - 株主通信 */ ?>
            ...
            <div class="p-ir-library">
                <nav class="c-cate-nav">
                    <ul class="c-cate-nav__list">
                        ...
                        <li class="c-cate-nav__item is-current"><a href="/ir/library/annual-report"><span>株主通信</span></a></li>
                    </ul>
                </nav>

                <div class="c-headline01 p-ir-library-ttl">
                    <p class="c-headline01__big"><span>Annual Report</span></p>
                    <h1 class="c-headline01__small"><span>株主通信（報告書）</span></h1>
                </div>

                <!-- E-IR Parts -->
<div class="eir" data-area-name="area_ir_material_006"></div>
